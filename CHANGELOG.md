...
- Удален пункт про "Lock branch" в инструкции по защите ветки,
так как это блокирует возможность слияния Pull Request'ов, даже если все проверки пройдены успешно.
